...
generated quantities {
...

	{
		...
		// fill in X array
		for (n in 1:NPred) {
			X_beakLenPred[n, 1] = ovaryLen_pred[n]; //parents ordered alphabetically
...

	{
		...
		for (n in 1:NPred) {
			...
			X_numPods2aryPred[n, 2] = ovuleArea_4pred[n]; //parents ordered alphabetically
...

	{
		...
		for (n in 1:NPred) {
			...
			X_tenPodNumberPred[n, 2] = ovuleNum_pred[n]; //parents ordered alphabetically
			X_tenPodNumberPred[n, 3] = podLen_pred[n]; //parents ordered alphabetically
		}
...

	{
		...
		// fill in X array
		for (n in 1:NPred) {
			X_tenPodAreaPred[n, 1] = tenPodNumber_pred[n]; //parents ordered alphabetically
		}
