...
generated quantities {
...

	{
		...
		for (n in 1:NPred) {
			...
			X_numFlowersPred[n, 3] = timeToFlower_pred[n]; //parents ordered alphabetically
		}
...

	{
		...
		for (n in 1:NPred) {
			...
			X_ovaryLenPred[n, 2] = styleLen_4pred[n]; //parents ordered alphabetically
		}
...

	{
		...
		// fill in X array
		for (n in 1:NPred) {
			X_ovuleNumPred[n, 1] = numFlowers_pred[n]; //parents ordered alphabetically
...

	{
		...
		for (n in 1:NPred) {
			...
			X_gynLenPred[n, 4] = timeToFlower_pred[n]; //parents ordered alphabetically
		}
...

	{
		...
		// fill in X array
		for (n in 1:NPred) {
			X_timeToMaturePred[n, 1] = ovuleACov_4pred[n]; //parents ordered alphabetically
			X_timeToMaturePred[n, 2] = percAborted2ary_pred[n]; //parents ordered alphabetically
		}
...

	{
		...
		// fill in X array
		for (n in 1:NPred) {
			X_totSeedNumPred[n, 1] = numPods2ary_pred[n]; //parents ordered alphabetically
			X_totSeedNumPred[n, 2] = tenPodNumber_pred[n]; //parents ordered alphabetically
...

	{
		...
		// fill in X array
		for (n in 1:NPred) {
			X_seedACovPred[n, 1] = totSeedNum_pred[n]; //parents ordered alphabetically
		}
...

	{
		...
		for (n in 1:NPred) {
			...
			X_TGWPred[n, 3] = totSeedArea_pred[n]; //parents ordered alphabetically
...

	{
		...
		for (n in 1:NPred) {
			...
			X_totSeedWPred[n, 5] = totSeedNum_pred[n]; //parents ordered alphabetically
		}
...

	{
		...
		// fill in X array
		for (n in 1:NPred) {
			X_oilContentPred[n, 1] = numFlowers_pred[n]; //parents ordered alphabetically
			X_oilContentPred[n, 2] = seedACov_pred[n]; //parents ordered alphabetically
			X_oilContentPred[n, 3] = styleLen_4pred[n]; //parents ordered alphabetically
			X_oilContentPred[n, 4] = totCompactness_pred[n]; //parents ordered alphabetically
			X_oilContentPred[n, 5] = totSeedArea_pred[n]; //parents ordered alphabetically
			X_oilContentPred[n, 6] = totSeedW_pred[n]; //parents ordered alphabetically
		}
